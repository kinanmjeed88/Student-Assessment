...
export default function ImportStudentsScreen() {
  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]}>
    <FlatList
      ...
      renderItem={({ item, index }) => <View style={styles.nameRow}><Text style={styles.nameText}>{item}</Text><Text style={styles.nameIndex}>{index + 1}</Text><Pressable accessibilityRole="button" accessibilityLabel={`حذف ${item}`} onPress={() => removeName(index)} style={({ pressed }) => [styles.remove, pressed && styles.pressed]}><MaterialIcons name="close" size={20} color={colors.danger} /></Pressable></View>}
...
const styles = StyleSheet.create({
  ...
  infoCard: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 12, borderRadius: 18, borderWidth: 1, borderColor: "#AECEEE", backgroundColor: "#EEF6FF", padding: 15, marginBottom: 18 },
  ...
  label: { color: colors.ink, textAlign: "right", fontWeight: "800", fontSize: 16, lineHeight: 23, marginBottom: 8 }, choices: { flexDirection: "row-reverse", flexWrap: "wrap", justifyContent: "flex-start", gap: 8, marginBottom: 16 }, muted: { color: colors.muted, fontSize: 15, lineHeight: 22, textAlign: "right", width: "100%" }, hint: { color: colors.muted, fontSize: 14, lineHeight: 21, textAlign: "right", marginTop: 9 },
  loading: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 10, paddingVertical: 15 }, loadingText: { color: colors.muted, fontSize: 15, lineHeight: 22, textAlign: "right" }, errorBox: { flexDirection: "row-reverse", alignItems: "center", gap: 9, backgroundColor: colors.dangerSurface, borderRadius: 14, borderWidth: 1, borderColor: "#E6A8AE", padding: 13, marginTop: 12 }, errorText: { flex: 1, color: colors.danger, fontSize: 14, lineHeight: 21, fontWeight: "700", textAlign: "right" },
  previewHeader: { backgroundColor: colors.white, borderColor: colors.border, borderWidth: 1, borderRadius: 18, padding: 15, marginTop: 20, marginBottom: 10 }, fileLine: { flexDirection: "row-reverse", alignItems: "center", gap: 8, justifyContent: "flex-start", marginBottom: 12 }, filename: { color: colors.navy, fontWeight: "800", fontSize: 14, lineHeight: 21, textAlign: "right", flexShrink: 1 }, previewTitle: { color: colors.ink, fontSize: 18, lineHeight: 26, fontWeight: "800", textAlign: "right" }, previewSubtitle: { color: colors.muted, fontSize: 14, lineHeight: 21, textAlign: "right", marginTop: 3 }, summaryRow: { flexDirection: "row-reverse", flexWrap: "wrap", justifyContent: "flex-start", gap: 8, marginTop: 14 }, summary: { minWidth: 104, borderRadius: 13, paddingHorizontal: 11, paddingVertical: 8, alignItems: "flex-end" }, summaryValue: { fontSize: 19, lineHeight: 25, fontWeight: "800", textAlign: "right" }, summaryLabel: { color: colors.ink, fontSize: 12, lineHeight: 17, fontWeight: "700", textAlign: "right" },
  nameRow: { minHeight: 58, borderWidth: 1, borderColor: colors.border, borderRadius: 14, backgroundColor: colors.white, paddingHorizontal: 12, flexDirection: "row-reverse", alignItems: "center", gap: 10, marginBottom: 8 }, remove: { width: 38, height: 38, borderRadius: 12, backgroundColor: colors.dangerSurface, alignItems: "center", justifyContent: "center" }, nameIndex: { color: colors.muted, fontSize: 14, fontWeight: "800", minWidth: 25, textAlign: "center" }, nameText: { flex: 1, minWidth: 0, color: colors.ink, fontSize: 16, lineHeight: 23, fontWeight: "700", textAlign: "right" }, pressed: { opacity: 0.7 },
