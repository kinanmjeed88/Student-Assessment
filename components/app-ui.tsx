...
const styles = StyleSheet.create({
  ...
  primary: { backgroundColor: colors.blueSurface, borderColor: colors.blue, borderWidth: 1.5, minHeight: 52, paddingHorizontal: 18, borderRadius: 14, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", columnGap: 8, alignSelf: "stretch" }, compact: { minHeight: 44, paddingHorizontal: 14, alignSelf: "auto" }, primaryText: { color: colors.navy, fontSize: 16, lineHeight: 23, fontWeight: "800", textAlign: "center", flexShrink: 1 }, disabled: { backgroundColor: "#E5EBF2", borderColor: "#C9D6E3" }, dim: { opacity: 0.72, transform: [{ scale: 0.985 }] },
  secondary: { minHeight: 46, borderRadius: 13, paddingHorizontal: 14, borderWidth: 1, borderColor: "#9DBCE2", backgroundColor: "#EDF5FF", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", columnGap: 7, flexShrink: 1 }, secondaryText: { color: colors.navy, fontWeight: "800", fontSize: 15, lineHeight: 21, textAlign: "center", flexShrink: 1 }, dangerOutline: { borderColor: "#E6A8AE", backgroundColor: colors.dangerSurface }, dangerText: { color: colors.danger },
